...
{
    public class AwardQuestionService
    {
        private readonly MongoDbService _mongoDbService;
        private readonly ILogger<AwardQuestionService> _logger;

        public AwardQuestionService(
            MongoDbService mongoDbService,
            ILogger<AwardQuestionService> logger)
        {
        ...
        public async Task<List<AwardQuestion>> GetAllAsync()
        {
            try
            {
                return await _mongoDbService.GetAllAsync<AwardQuestion>();
            }
            catch (Exception ex)
            {
        ...
        public async Task<AwardQuestion?> GetByIdAsync(string id)
        {
            try
            {
                return await _mongoDbService.GetByIdAsync<AwardQuestion>(id);
            }
            catch (Exception ex)
            {
        ...
        public async Task<List<AwardQuestion>> GetActiveAsync()
        {
            try
            {
                var questions = await _mongoDbService.GetAllAsync<AwardQuestion>();
        ...
        public async Task<bool> DeleteAsync(string id)
        {
            try
            {
                ...
                await _mongoDbService.DeleteAsync<AwardQuestion>(id);
